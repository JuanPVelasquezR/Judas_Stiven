...
namespace InventarioAPP.Controllers
{
    ...
    {
        private readonly InventarioTecnologiaContext _context;

        public ProductoesController(InventarioTecnologiaContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdProducto,Nombre,Descripcion,IdCategoria,PrecioCompra,PrecioVenta,Stock,IdProveedor")] Producto producto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdProducto,Nombre,Descripcion,IdCategoria,PrecioCompra,PrecioVenta,Stock,IdProveedor")] Producto producto)
        {
